...
export const environment = {
  isLocalInside: false,
  apiUrl: "http://localhost:2030/api/",
 serverUrlImages: "http://localhost:2030/images/",
  AuthBaseUrl: "http://localhost:2030/api/auth/",
  allowedDomains: ['localhost:2030'],
  disallowedRoutes: ['localhost:2030/api/auth'],
  defaultLanguage:{name:'ar'} ,
  dashboardSettingMedia:"http://localhost:2030/SettingMedia/",
